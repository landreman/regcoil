...
numFailures += arrayShouldBe(data, [0.0106199394066055],desiredTolerance)

variableName = 'chi2_J'
data = f.variables[variableName][()]
desiredTolerance = 1e-4
numFailures += arrayShouldBe(data, [180027864932680], desiredTolerance)

variableName = 'max_Bnormal'
data = f.variables[variableName][()]
desiredTolerance = 1e-4
numFailures += arrayShouldBe(data, [0.0961657657267785], desiredTolerance)

variableName = 'max_J'
data = f.variables[variableName][()]
desiredTolerance = 1e-4
numFailures += arrayShouldBe(data, [7676633.79432514], desiredTolerance)
...
numFailures += arrayShouldBe(data[0,:], [447.38366099137, 4639.9189494066, -1606.04570821836, -32567.0650920621,
    ...
    14567.7808069598   ],desiredTolerance,requireSameLength=False)
