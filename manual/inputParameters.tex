...
{real}
{1.0d4}
{When \parlink{sensitivity\_option}$> 1$ and \parlink{fixed\_norm\_sensitivity\_option}= true.}
{If \parlink{fixed\_norm\_sensitivity} = true, the derivative of $K_{\max}$ will be computed using a log-sum-exponent approximation. 
\begin{gather}
