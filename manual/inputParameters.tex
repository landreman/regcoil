...
{\ttfamily target\_option} = 1: Search for the $\lambda$ value such that the maximum
current density over the winding surface equals \parlink{current\_density\_target}.\\

{\ttfamily target\_option} = 2: Search for the $\lambda$ value such that the root-mean-square current density
