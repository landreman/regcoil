subroutine adjoint_solve
  ...
  real(dp), dimension(:,:), allocatable :: adjoint_Ax, adjoint_Ay, adjoint_Az, dKDifferencedomega
  ...
  if (sensitivity_option == 3 .or. sensitivity_option == 5 .or. fixed_norm_sensitivity_option > 1) then
