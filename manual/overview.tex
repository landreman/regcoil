...
The former standalone \matlab~solver ({\ttfamily regcoil.m}) and related scripts have been removed.
A temporary coil-visualization script {\ttfamily m20160811\_01\_plotCoilsFromRegcoil.m} remains
until it is replaced by a Python/Plotly tool.
...
You can also make a 3D figure of the shapes of discrete coils using the temporary \matlab~program {\ttfamily m20160811\_01\_plotCoilsFromRegcoil.m}.
