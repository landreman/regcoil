...
13. **Unit + regression tests** — pytest for Python and integration; unit tests for the Fortran kernels go through the `regcoil._core` extension, no separate Fortran test framework (ADR-008). CI on GitHub Actions.
