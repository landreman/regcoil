...
{When \parlink{general\_option}=1, {\ttfamily N\_lambda} is the number of values of $\lambda$ for which the problem is solved.
When \parlink{general\_option}=4 or 5, {\ttfamily N\_lambda} is the upper limit on the number of values of $\lambda$ for which the problem is solved.}
...
{8.0e6}
{Only when \parlink{general\_option}=4 or 5.}
{The value of root-mean-square or maximum current density used to determine $\lambda$.
