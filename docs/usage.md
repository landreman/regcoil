...
`simsopt.mhd.Vmec` object. Simsopt need not be installed unless you pass a `Vmec` object:

```python
from simsopt.mhd import Vmec

vmec = Vmec("wout_li383_1.4m.nc")
plasma = regcoil.PlasmaSurface.from_wout(vmec)
```
